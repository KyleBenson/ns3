...
int main(int argc, char *argv[])
{
	...
	("seed,s",po::value<int>(&opt_seed),"random seed (default: system time)")
	("rewire_count,w",po::value<int>(&opt_rewireCount),"# of attempts to re-wire all disconnected components to GCC (default: 0)")
//	("output,o",po::value<string>(&opt_outfile),"output file (default: stdout)")
    ...
    {
	cerr << "Could not read 1k distribution:" <<  opt_infile
	     << endl;
	return 1;
    }
